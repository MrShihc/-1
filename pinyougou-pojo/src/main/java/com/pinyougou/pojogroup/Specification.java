...
public class Specification implements Serializable {
    ...
    private TbSpecification tbSpecification = new TbSpecification();

    private List<TbSpecificationOption> tbSpecificationOptionList = new ArrayList<TbSpecificationOption>();
